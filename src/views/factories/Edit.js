...
const Edit= () => {
  ...
  const {id,name:Name,company_name:companyName,cim_no:cimNo,uam_no:uamNo,factoryproductionlines:TestDirection} = location.state || {}; // Default to an empty object if state is undefined
 ...
 const [formDatas, setFormDataS] = useState({
  ...
  const handleEditAddress = ()=>{
    navigate('/factories/edit/address',{ state: id });
  }
