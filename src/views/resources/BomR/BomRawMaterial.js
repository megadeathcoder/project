...
const BomRawMaterial = () => {
  ...
  const [data, setData] = useState( [
    ...
    { id: 3, BomRawMaterialCategoryName: 'Stabilizer', SortOrder: '3'},
    { id: 4, BomRawMaterialCategoryName: 'Foaming Agent', SortOrder: '4'},
    { id: 5, BomRawMaterialCategoryName: 'Filler', SortOrder: '5'},
    { id: 6, BomRawMaterialCategoryName: 'Solvent', SortOrder: '6'},
    { id: 7, BomRawMaterialCategoryName: 'Additives', SortOrder: '7'},
    { id: 8, BomRawMaterialCategoryName: 'Special Chemicals', SortOrder: '8'},
    { id: 9, BomRawMaterialCategoryName: 'Pigment', SortOrder: '9'},
    { id: 10, BomRawMaterialCategoryName: 'PVC Paste Resin', SortOrder: '10'},
      ...
      <table className="table" style={tableStyle}>
            ...
            <th>Actions</th>
              ...
              <tbody>
                {data.map((product) => (
                  <tr key={product.id}>
                  <td>{product.BomRawMaterialCategoryName}</td>
