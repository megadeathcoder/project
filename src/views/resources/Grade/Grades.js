...
const Grades = () => {
  ...
  const [data, setData] = useState([
    { id: 1, GradeName: 'CP', DiscountPercentage: '0', DefaultToFactoryStock: '1'},
    { id: 2, GradeName: 'CP', DiscountPercentage: '0', DefaultToFactoryStock: '0'},
    { id: 3, GradeName: 'CP', DiscountPercentage: '0', DefaultToFactoryStock: '1'},
    { id: 4, GradeName: 'CP', DiscountPercentage: '0', DefaultToFactoryStock: '0'},
    { id: 5, GradeName: 'CP', DiscountPercentage: '0', DefaultToFactoryStock: '1'},
  ]);
  // const data = [
            ...
            <th>Actions</th>
              ...
              <tbody>
                {data.map((product) => (
                  ...
                  <td>{product.DefaultToFactoryStock === '1'?'yes':'no'}</td>
                  <td>
