...
const Add = () => {
  ...
  const {DisplayName, Status,UseThisasdefaultstatusforOrders, NotifyCustomersviaEmailandSMS,ShortDescription,SmsContent,Subject} = location.state || {}; // Default to an empty object if state is undefined
