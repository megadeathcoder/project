...
const Edit = () => {
  ...
  const {id,display_name:DisplayName, name:ConfigName, type:SearchType,value:Value,is_trashed:isTrashed} = location.state.item || {}; // Default to an empty object if state is undefined
