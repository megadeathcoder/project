...
const ConfigDefault = () => {
  ...
  //   { id: 3, DisplayName: 'Grades', ConfigName: 'grading', SearchType: 'year', Value: '1'},
  //   { id: 4, DisplayName: 'Grades', ConfigName: 'grading', SearchType: 'year', Value: '1'},
  //   { id: 5, DisplayName: 'Grades', ConfigName: 'grading', SearchType: 'year', Value: '1'},
  //   { id: 6, DisplayName: 'Grades', ConfigName: 'grading', SearchType: 'year', Value: '1'},
  //   { id: 7, DisplayName: 'Grades', ConfigName: 'grading', SearchType: 'year', Value: '1'},
  //   { id: 8, DisplayName: 'Grades', ConfigName: 'grading', SearchType: 'year', Value: '1'},
  //   { id: 9, DisplayName: 'Grades', ConfigName: 'grading', SearchType: 'year', Value: '1'},
  //   { id: 10, DisplayName: 'Grades', ConfigName: 'grading', SearchType: 'year', Value: '1'},
  // ];
  const tableStyle = {
    // margin: 'auto', 
    // width: '60%',  
